import pygame
import ext_elev
import ex3_random as student   # swap to "import ex3 as student" to drive with your controller
from enum import Enum


# ---------------------------------------------------------------- #
# Problem                                                          #
# (the probabilities and reward lists below are HIDDEN from your    #
#  controller; they are only used by the engine.)                   #
# ---------------------------------------------------------------- #
problem = {
    "height": 6,
    "Elevators": {
...
pygame.display.set_caption("RL Multi-Elevator")
